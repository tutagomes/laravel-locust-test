...
<div class="tocify-wrapper">
    ...
    <ul id="toc">
            ...
            <li>Last updated: October 7 2020</li>
        </ul>
</div>
...
<pre><code class="language-json">{
    ...
    "info": {
        "name": "Teste API",
        "_postman_id": "01aed8f9-5fa7-43e8-b68e-4b2e5c1434b1",
        "description": "",
            ...
            "item": [
                {
                    ...
                    "request": {
                        "url": {
                            ...
                            "path": "api\/v1\/todo",
                            "query": [],
                            "raw": "http:\/\/localhost\/api\/v1\/todo"
                        },
                        "method": "GET",
                        "header": [
                            {
                ...
                },
                {
                    ...
                    "request": {
                        "url": {
                            ...
                            "query": [],
                            "raw": "http:\/\/localhost\/api\/v1\/todo\/:todo"
                        },
                        "method": "GET",
                        "header": [
                            {
            ...
            "item": [
                {
                    ...
                    "request": {
                        "url": {
                            ...
                            "path": "api\/v2\/todo",
                            "query": [],
                            "raw": "http:\/\/localhost\/api\/v2\/todo"
                        },
                        "method": "GET",
                        "header": [
                            {
                ...
                },
                {
                    ...
                    "request": {
                        "url": {
                            "protocol": "http",
                            "host": "localhost",
                            "path": "api\/v2\/todo\/:todo",
                            "query": [],
                            "raw": "http:\/\/localhost\/api\/v2\/todo\/:todo"
                        },
                        "method": "GET",
                        "header": [
                            {
            ...
            "item": [
                {
                    ...
                    "request": {
                        "url": {
                            ...
                            "path": "api\/v3\/todo",
                            "query": [],
                            "raw": "http:\/\/localhost\/api\/v3\/todo"
                        },
                        "method": "GET",
                        "header": [
                            {
                ...
                },
                {
                    ...
                    "request": {
                        "url": {
                            "protocol": "http",
                            "host": "localhost",
                            "path": "api\/v3\/todo\/:todo",
                            "query": [],
                            "raw": "http:\/\/localhost\/api\/v3\/todo\/:todo"
                        },
                        "method": "GET",
                        "header": [
                            {
...
<pre><code class="language-bash">curl -X POST \
    ...
    -d '{"email":"officiis","password":"adipisci"}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/login"
);
...
<h3>Request</h3>
<p><small class="badge badge-green">GET</small>
<strong><code>/</code></strong></p><h1>Todo V1</h1>
<p>APIs para controlar tarefas - versão 1</p>
<h2>Mostra todas as tarefas</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
<pre><code class="language-bash">curl -X GET \
...
<h3>Request</h3>
<p><small class="badge badge-green">GET</small>
<strong><code>api/v1/todo</code></strong></p>
<h2>Cria uma nova tarefa</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
<pre><code class="language-bash">curl -X POST \
...
<strong><code>api/v1/todo</code></strong></p>
<h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
<p><code><b>title</b></code>&nbsp; <small>string</small>     <br>
Titulo da Tarefa.</p>
<p><code><b>description</b></code>&nbsp; <small>string</small>     <br>
Descrição da Tarefa.</p>
<p><code><b>notes</b></code>&nbsp; <small>string</small>     <br>
Notas relacionadas à Tarefa.</p>
<p><code><b>done</b></code>&nbsp; <small>boolean</small>     <br>
Indicativo de que tarefa foi concluída.</p>
<h2>Mostra uma tarefa</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
<pre><code class="language-bash">curl -X GET \
...
<h3>Request</h3>
<p><small class="badge badge-green">GET</small>
<strong><code>api/v1/todo/{todo}</code></strong></p>
<h2>Atualiza uma tarefa</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
...
<strong><code>api/v1/todo/{todo}</code></strong></p><h1>Todo V2</h1>
<p>APIs para controlar tarefas - versão 2</p>
<h2>Mostra todas as tarefas</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
...
<h3>Request</h3>
<p><small class="badge badge-green">GET</small>
<strong><code>api/v2/todo</code></strong></p>
<h2>Cria uma nova tarefa</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
...
<h3>Request</h3>
<p><small class="badge badge-green">GET</small>
<strong><code>api/v2/todo/{todo}</code></strong></p>
<h2>Atualiza uma tarefa</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
...
<h3>Request</h3>
<p><small class="badge badge-red">DELETE</small>
<strong><code>api/v2/todo/{todo}</code></strong></p><h1>Todo V3</h1>
<p>APIs para controlar tarefas - versão 3</p>
<h2>Mostra todas as tarefas</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
...
<h3>Request</h3>
<p><small class="badge badge-green">GET</small>
<strong><code>api/v3/todo</code></strong></p>
<h2>Cria uma nova tarefa</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
...
<h3>Request</h3>
<p><small class="badge badge-green">GET</small>
<strong><code>api/v3/todo/{todo}</code></strong></p>
<h2>Atualiza uma tarefa</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
